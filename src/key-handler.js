...
class KeyHandler {
    ...
    _keyMap(){
      ...
      return {
        ...
        '4': () => this.eventActions.useQuadSet4(),
        '5': () => this.eventActions.useQuadSet5(),
        '6': () => this.eventActions.useQuadSet6(),
        '7': () => this.eventActions.useQuadSet7(),
        '8': () => this.eventActions.useQuadSet8(),
        '9': () => this.eventActions.useQuadSet9(),
        '0': () => this.eventActions.useQuadSet10(),
